...
class AdaptedLaplaceWrapper(DistributionalWrapper):
    ...
    Args:
        ...
        hessian_structure: Structure of the Hessian approximation
            ("kron", "full", or "diag").
        subset_of_weights: Subset of weights to consider for inference
            (only here "subnetwork").
        subnetwork_layers: List of layer names ['layer1', 'layer2', ...]
    """
    ...
    def __init__(
        ...
        subset_of_weights: str = "subnetwork",
        subnetwork_layers: list[str] = None,
    ) -> None:
        ...
        self._subnetwork_layers = subnetwork_layers 
